...
import type { BlobListResult, BlobMultipartUpload, HandleMPUResponse, BlobMultipartOptions, BlobUploadOptions, BlobPutOptions, BlobEnsureOptions, BlobObject, BlobListOptions } from '@nuxthub/core';
interface HubBlob {
    /**
 ...
 * @see https://hub.nuxt.com/docs/features/blob
 */
export declare function proxyHubBlob(projectUrl: string, secretKey?: string): HubBlob;
/**
