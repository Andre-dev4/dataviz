  ...
  <div>
    ...
    <div class="info-boxes">
        ...
        <div v-if="graphDatas && overItem" class="info-box-content">
          ...
          <div class="desc">
            ...
            <div>
              ...
              >
              par rapport au total de voitures immatriculées
            </div>
            <div class="result nopad res2">
               <span v-if="currCatVehic === 'gaz'"> {{ overItem.y }}</span>
               <span v-else>{{ Math.round(overItem.y) }}</span>
              <span v-if="currCatVehic === 'gaz'">stations GNV</span
              ><span v-else>points de charge publiques</span>
            </div>
            <div>
              pour 1000
      ...
      <div class="info-box legend">
        <div class="info-box-detector" v-observe-visibility="legendVisibilityChanged"></div>
    ...
    <div class="graph" :data-cat="cat" v-observe-visibility="graphVisibilityChanged">
    ...
    <div class="section-legend">
      <div class="legend yaxis">
        <div class="legend-img">
          <img src="~assets/_svg/legend-yaxis-scatter.svg" />
        </div>
        <div class="legend-text">
          Nombre de <span v-if="currCatVehic === 'gaz'">stations GNV</span
          ><span v-else>points de charge publiques</span> pour 1000
          <span v-if="currCatVehic === 'gaz'">véhicules au gaz</span
          ><span v-else>voitures électriques et hybrides rechargeables</span>
        </div>
      </div>
      ...
      <div class="legend xaxis">
        ...
        <div class="legend-text">
          ...
          <span v-if="currCatVehic === 'gaz'">véhicules au gaz</span
          ><span v-else>voitures électriques et hybrides rechargeables</span>
          par rapport au total de voitures immatriculés
        </div>
      </div>
    </div>
  </div>
    ...
    graphDatas() {
      ...
      let graphDatas = _.map(processedDatas, function (fEntry, fEntryIndex) {
        ...
        if (_self.currCatVehic === 'gaz') {
          ...
          returnedObj.xA = fEntry.stations_gnv_reg
          returnedObj.xB = fEntry.c_total_gnv
          ...
          // console.log('>>>>pdc', fEntry.label, pdc, pdc.toFixed(1))
          const perc = parseFloat(
            (
              (fEntry['c_' + _self.current_type_vehicule.id] /
          ...
          returnedObj.xA = fEntry.sum_pdc
          returnedObj.xB = fEntry['c_' + _self.current_type_vehicule.id]
