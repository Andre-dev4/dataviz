    ...
    >
      ...
      <div class="item-content">
        <div class="item-content-head">
          ...
          <div class="item-label">{{ item.label }}</div>
          <div class="item-txt">
            <span class="value" v-html="valueTxt(item.y)"></span> <span v-if="currCatVehic === 'gaz'">véhicules au gaz</span><span v-else>véhicules électriques et hybrides rechargeables</span> par <span v-if="currCatVehic === 'gaz'">station GNV</span
                ><span v-else
                  >point de charge</span
                ><span class="volume-data">soit {{item.vol}} <span v-if="currCatVehic === 'gaz'">stations GNV</span
                ><span v-else
                  >points de charge</span> pour {{item.nb}} <span v-if="currCatVehic === 'gaz'">véhicules au gaz</span
                ><span v-else
