            ...
            <div class="desc">
              <span v-if="cat === 'vehic'">
                ...
                <span class="volume-data">soit {{graphDatas.currValueVol}} véhicule(s) <span v-if="currCatVehic === 'gaz'"> au gaz</span><span v-else
                  >électriques et hybrides rechargeables</span><br>pour {{graphDatas.currValueNb}} véhicules immatriculés</span>
              </span>
              <span v-else>
                <span class="result"
            ...
            <div class="desc">
              <span v-if="cat === 'vehic'">
                ...
                <span class="volume-data">soit {{overItem.vol}} véhicule(s) <span v-if="currCatVehic === 'gaz'"> au gaz</span><span v-else
                  >électriques et hybrides rechargeables</span><br>pour {{overItem.nb}} véhicules immatriculés</span>
              </span>
              <span v-else>
                <span class="result">{{ overItem.valueText }}</span>
                pour 1000 <span v-if="currCatVehic === 'gaz'">véhicules au gaz</span
                ><span v-else
                  >voitures électriques et hybrides rechargeables</span
            ...
            <div class="desc">
              <span v-if="cat === 'vehic'">
                ...
                <span class="volume-data">soit {{graphDatas.FirstValueVol}} véhicule(s) <span v-if="currCatVehic === 'gaz'"> au gaz</span><span v-else
                  >électriques et hybrides rechargeables</span><br>pour {{graphDatas.FirstValueNb}} véhicules immatriculés</span>
              </span>
              <span v-else>
                <span class="result">{{ graphDatas.FirstValueText }} <span v-if="currCatVehic === 'gaz'">stations GNV</span>
                <span v-else>points de charge</span>
                </span>
                pour 1000
                <span v-if="currCatVehic === 'gaz'">véhicules au gaz</span
                ><span v-else>véhicules hybrides rechargeables</span
        ...
        if (_self.cat === 'pdc') {
          ...
          if (_self.currCatVehic === 'gaz') {
            const pdc = parseFloat(
              ((fEntry.stations_gnv_reg * 1000) / fEntry.c_total_gnv).toFixed(1)
            )
